...
static s_sis_method _sisdb_rsno_v1_methods[] = {
  ...
  {"unsub",  cmd_sisdb_rsno_v1_unsub, 0, NULL},
  {"get",    cmd_sisdb_rsno_v1_get, 0, NULL},
  {"setcb",  cmd_sisdb_rsno_v1_setcb, 0, NULL}
};

///////////////////////////////////////////////////
// *** s_sis_modules sis_modules_[dir name]  *** //
///////////////////////////////////////////////////
s_sis_modules sis_modules_sisdb_rsno_v1 = {
    sisdb_rsno_v1_init,
    NULL,
    sisdb_rsno_v1_working,
    NULL,
    sisdb_rsno_v1_uninit,
    NULL,
    NULL,
    sizeof(_sisdb_rsno_v1_methods)/sizeof(s_sis_method),
    _sisdb_rsno_v1_methods,
};

bool sisdb_rsno_v1_init(void *worker_, void *node_)
{
    ...
    s_sisdb_rsno_v1_cxt *context = SIS_MALLOC(s_sisdb_rsno_v1_cxt, context);
...
void sisdb_rsno_v1_uninit(void *worker_)
{
    s_sis_worker *worker = (s_sis_worker *)worker_; 
    s_sisdb_rsno_v1_cxt *context = (s_sisdb_rsno_v1_cxt *)worker->context;

    sisdb_rsno_v1_sub_stop(context);
...
///////////////////////////////////////////
static void _send_rsno_compress(s_sisdb_rsno_v1_cxt *context, int issend)
{
	...
	if ((issend && zipmem->size > 0 ) || (int)zipmem->size > context->rsno_ziper->zip_size - 256)
	{
		...
		{	
			context->cb_sub_inctzip(context->cb_source, zipmem);
		}
...
{
    s_sisdb_rsno_v1_cxt *context = (s_sisdb_rsno_v1_cxt *)context_;
...
{
    s_sisdb_rsno_v1_cxt *context = (s_sisdb_rsno_v1_cxt *)argv_;
...
void sisdb_rsno_v1_sub_start(s_sisdb_rsno_v1_cxt *context) 
{
...
void sisdb_rsno_v1_sub_stop(s_sisdb_rsno_v1_cxt *context)
{
...
//  method define
/////////////////////////////////////////
int cmd_sisdb_rsno_v1_sub(void *worker_, void *argv_)
{
    s_sis_worker *worker = (s_sis_worker *)worker_; 
    s_sisdb_rsno_v1_cxt *context = (s_sisdb_rsno_v1_cxt *)worker->context;
    ...
    sisdb_rsno_v1_sub_start(context);

    return SIS_METHOD_OK;
}
int cmd_sisdb_rsno_v1_unsub(void *worker_, void *argv_)
{
    s_sis_worker *worker = (s_sis_worker *)worker_; 
    s_sisdb_rsno_v1_cxt *context = (s_sisdb_rsno_v1_cxt *)worker->context;
...
int cmd_sisdb_rsno_v1_get(void *worker_, void *argv_)
{
    s_sis_worker *worker = (s_sis_worker *)worker_; 
    s_sisdb_rsno_v1_cxt *context = (s_sisdb_rsno_v1_cxt *)worker->context;
    s_sis_message *msg = (s_sis_message *)argv_; 
...
int cmd_sisdb_rsno_v1_setcb(void *worker_, void *argv_)
{
    s_sis_worker *worker = (s_sis_worker *)worker_; 
    s_sisdb_rsno_v1_cxt *context = (s_sisdb_rsno_v1_cxt *)worker->context;
...
void sisdb_rsno_v1_working(void *worker_)
{
    s_sis_worker *worker = (s_sis_worker *)worker_; 
    s_sisdb_rsno_v1_cxt *context = (s_sisdb_rsno_v1_cxt *)worker->context;
