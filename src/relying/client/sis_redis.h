...
//---------- socket 使用方法 ----------//
	...
	// sis_socket_send_message(socket*,s_sis_message_node*);
	// sis_socket_query_message(socket*,s_sis_message_node*);
...
bool sis_redis_send_message(s_sis_socket *, s_sis_message_node *);
// s_sis_list_node *sis_redis_recv_message(s_sis_socket *, s_sis_message_node *);
//发信息并等待服务器响应,收到一个完整的信息链
s_sis_message_node *sis_redis_query_message(s_sis_socket *, s_sis_message_node *); 
