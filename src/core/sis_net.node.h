...
#define SIS_NET_ASK_MESSAGE    0  // 请求

#define SIS_NET_REPLY_STRING   1  // 有数据 返回一个缓存区  rval
#define SIS_NET_REPLY_ARRAY    2  // 有数据 返回一个列表数据 rlist
#define SIS_NET_REPLY_INTEGER  3  // 有数据 返回一个整数    rint 
#define SIS_NET_REPLY_OK      10  // 没有数据 rval 为空
#define SIS_NET_REPLY_ERR     11  // 没有数据 NIL BUSY ... rval 为错误字符串
