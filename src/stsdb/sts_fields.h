...
/////////////////////////////////////////////////////////
//关于时间的定义
#define STS_FIELD_INDEX   0 // "TIDX"  //int32 表示序号 0.....1000....
#define STS_FIELD_TIME    1 // "TTIME"  //int64 精确到毫秒的时间  
#define STS_FIELD_SECOND  2 // "TSEC"  //int32 time_t格式，精确到秒  
#define STS_FIELD_MINUTE  3 // "TMIN"  //int32 time_t格式 / 60，精确到分
#define STS_FIELD_DAY     4 // "TDAY"  //int32 20170101格式，精确到天
#define STS_FIELD_MONTH   5 // "TMON"  //int32 201703格式，精确到月
#define STS_FIELD_YEAR    6 // "TYEAR"  //int16 2017格式，精确到年
//8位代码定义
#define STS_FIELD_CODE    7 // "TCODE"  //int64 -- char[8] 8位字符转换为一个int64为索引
//其他类型定义
...
typedef struct sts_field_unit{
	uint8_t  index;   // 位置，结构中第几个字段
	uint16_t offset;  // 偏移位置，结构中第几个字段
