...
void destroy_stepindex(s_sts_step_index *);
void stepindex_rebuild(s_sts_step_index *, uint64 left_, uint64 right_, int count_);
...
void destroy_sts_collect_unit(s_sts_collect_unit *);
...
int sts_collect_unit_update(s_sts_collect_unit *, const char *in_, size_t inLen_);
