...
#include <sisdb_wsno_v1.h>

// 从行情流文件中获取数据源
static s_sis_method _sisdb_wsno_v1_methods[] = {
  {"init",   cmd_sisdb_wsno_v1_init,  0, NULL},
  {"getcb",  cmd_sisdb_wsno_v1_getcb, 0, NULL},
};

///////////////////////////////////////////////////
// *** s_sis_modules sis_modules_[dir name]  *** //
///////////////////////////////////////////////////
s_sis_modules sis_modules_sisdb_wsno_v1 = {
    sisdb_wsno_v1_init,
    NULL,
    NULL,
    NULL,
    sisdb_wsno_v1_uninit,
    NULL,
    NULL,
    sizeof(_sisdb_wsno_v1_methods)/sizeof(s_sis_method),
    _sisdb_wsno_v1_methods,
};

bool sisdb_wsno_v1_init(void *worker_, void *node_)
{
    s_sis_worker *worker = (s_sis_worker *)worker_; 
    s_sis_json_node *node = (s_sis_json_node *)node_;

    s_sisdb_wsno_v1_cxt *context = SIS_MALLOC(s_sisdb_wsno_v1_cxt, context);
...
void sisdb_wsno_v1_uninit(void *worker_)
{
    s_sis_worker *worker = (s_sis_worker *)worker_; 
    s_sisdb_wsno_v1_cxt *context = (s_sisdb_wsno_v1_cxt *)worker->context;
...
static int _write_head(s_sisdb_wsno_v1_cxt *context, bool iszip)
{
...
static int cb_sub_inctzip(void *worker_, void *argv_)
{
	s_sis_worker *worker = (s_sis_worker *)worker_; 
    s_sisdb_wsno_v1_cxt *context = (s_sisdb_wsno_v1_cxt *)worker->context;
...
static int cb_unzip_info(void *source, int kidx, int sidx, char *in, size_t ilen)
{
    ...
    s_sisdb_wsno_v1_cxt *context = (s_sisdb_wsno_v1_cxt *)source;
...
//  method define
/////////////////////////////////////////
int cmd_sisdb_wsno_v1_init(void *worker_, void *argv_)
{
    return SIS_METHOD_OK; 
}
int cmd_sisdb_wsno_v1_getcb(void *worker_, void *argv_)
{
    s_sis_worker *worker = (s_sis_worker *)worker_; 
    // s_sisdb_wsno_v1_cxt *context = (s_sisdb_wsno_v1_cxt *)worker->context;
    ...
    sis_message_set_method(msg, "cb_sub_inctzip" ,cb_sub_inctzip);
