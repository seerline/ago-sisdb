#ifndef _SISDB_RSNO_V1_H
#define _SISDB_RSNO_V1_H
...
typedef struct s_sisdb_rsno_v1_cxt
{
    int               status;        // 工作状态
...
bool sisdb_rsno_v1_init(void *, void *);
void sisdb_rsno_v1_uninit(void *);

void sisdb_rsno_v1_working(void *);
