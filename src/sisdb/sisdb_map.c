...
static struct s_sis_map_define _sis_map_defines[] = {
	...
	/////////////时间接收和存储时的格式定义/////////////
	{"NONE", SIS_MAP_DEFINE_TIME_FORMAT, SIS_TIME_SCALE_NONE, 0},
	{"INCR", SIS_MAP_DEFINE_TIME_FORMAT, SIS_TIME_SCALE_INCR, 0},
	{"MSEC", SIS_MAP_DEFINE_TIME_FORMAT, SIS_TIME_SCALE_MSEC, 0},
	{"SECOND", SIS_MAP_DEFINE_TIME_FORMAT, SIS_TIME_SCALE_SECOND, 0},
	{"DATE", SIS_MAP_DEFINE_TIME_FORMAT, SIS_TIME_SCALE_DATE, 0},
	/////////////字段类型定义/////////////
	...
	{"J", SIS_MAP_DEFINE_DATA_TYPE, SIS_DATA_TYPE_JSON, 0},
	{"C", SIS_MAP_DEFINE_DATA_TYPE, SIS_DATA_TYPE_CSV, 0},
	{"A", SIS_MAP_DEFINE_DATA_TYPE, SIS_DATA_TYPE_ARRAY, 0}
};
